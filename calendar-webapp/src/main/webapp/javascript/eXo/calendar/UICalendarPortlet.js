(function(base, gtnav, CalendarLayout,cs, UIWeekView, UICalendarMan, gj, Reminder, UICalendars, uiForm, uiPopupWindow, wx) {
...
*/
    ...
    var menuY = cs.Browser.Browser.findPosY(clickobj) + clickobj.offsetHeight;
    if (arguments.length > 2) {
...
UISelection.prototype.clear = function(){
	...
	//eXo.uiForm.submitEvent(UISelection.viewType, 'QuickAdd', '&objectId=Event&startTime=' + startTime + '&finishTime=' + endTime);
...
//			}; 
	...
	getRealTime: function(data){
		...
		var df = cs.CSUtils.DateTimeFormater;
		if(type == 1){
...
return _module;
})(base, gtnav, CalendarLayout,cs, UIWeekView, UICalendarMan, gj, Reminder, UICalendars, uiForm, uiPopupWindow, wx);
